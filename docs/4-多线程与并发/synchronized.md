...
<p style="text-align: center;"><img src="_media/concurrent/mark_word.png" alt="对象头" style="width: 80%"></p>
...
<p style="text-align: center;"><img src="_media/concurrent/object_monitor.png" alt="监视器锁" style="width: 60%"></p>
